    ...
    public class DockContentHandler : IDisposable, IDockDragSource
    {
        ...
        public void Show(DockPanel dockPanel, Rectangle floatWindowBounds)
        {
            ...
            if (FloatPane == null)
            {
                ...
                if (m_form.MinimumSize.Width >0 && m_form.MinimumSize.Height>0) 
                    m_form.MinimumSize = new Size(m_form.MinimumSize.Width - ncWidth, m_form.MinimumSize.Height - ncHeight); // GR
            }
